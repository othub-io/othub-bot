...
const commands = {
  ...
  'othub-bot-restart': 'systemctl restart othub-bot',
  'othub-bot-stop': 'systemctl stop othub-bot',
  'othub-bot-start': 'systemctl start othub-bot',
  'othub-bot-logs': 'journalctl -u othub-bot --output cat -n 100',
  ...
  'otnode-api-estart': 'systemctl restart otnode-api',
  'otnode-api-top': 'systemctl stop otnode-api',
  'otnode-api-tart': 'systemctl start otnode-api',
  'otnode-api-ogs': 'journalctl -u otnode-api --output cat -n 100',
